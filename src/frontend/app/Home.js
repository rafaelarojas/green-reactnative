...
import { View, Text, FlatList, StyleSheet, SafeAreaView, Image, TouchableOpacity, ActivityIndicator, ScrollView } from 'react-native';
            ...
            <View style={styles.card}>
              ...
              {expandedItems[item.id] && (
                <ScrollView style={styles.details}>
                  {/* Linha de ícones: avaliação, caloria, tempo */}
...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontWeight: 'bold', marginTop: 8, marginBottom: 4, color: '#2b8a3e' },
